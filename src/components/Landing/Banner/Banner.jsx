  ...
  return (
    <div className="px-5 sm:px-10 py-8 z-30" id="home">
      ...
      <div className="flex max-lg:flex-wrap max-lg:justify-center">
        ...
        <div className="lg:basis-1/2 lg:pl-16 max-lg:text-center max-lg:flex max-lg:items-center max-lg:flex-col max-sm:px-5" data-aos="fade-left" data-aos-delay="100" data-aos-duration="3000">
