...
const Vision = () => {
  return (
    <div className='px-5 sm:px-10 mt-8 lg:mt-52 relative pb-36 sm:pb-[320px] lg:pb-[550px] 2xl:pb-[800px] z-30' id="vision">
        <div className='max-w-full lg:max-w-2xl 2xl:max-w-[800px] max-lg:flex max-lg:items-center max-lg:flex-col max-sm:text-center' data-aos="fade-right" data-aos-delay="100" data-aos-duration="2000">
        ...
        <div className='absolute top-12 -right-[87px] w-[400px] h-[400px] max-lg:hidden' data-aos="fade-left" data-aos-delay="100" data-aos-duration="2000">
