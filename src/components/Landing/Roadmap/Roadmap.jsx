...
const Roadmap = () => {
  return (
    <div className="relative z-30" id="roadmap">
      ...
      <div className="px-5 sm:px-10 lg:px-20 py-24  ">
      ...
      <div className="px-5 sm:px-10 lg:px-20 py-12 " id="howtobuy">
        <h2 className="uppercase text-center">How to Buy</h2>
        <div className="grid lg:grid-cols-2  gap-8 ">
          <div className="px-6 lg:px-12 py-8 lg:py-16  rounded-3xl lg:rounded-[48px] border border-gray shadow1 mx-auto flex-col justify-center relative mt-16 w-full bg-dark-black text-white zindex-1">
          ...
          <div className="px-6 lg:px-12 py-8 lg:py-16 rounded-3xl lg:rounded-[48px] border border-gray shadow1 mx-auto flex-col justify-center relative mt-0 lg:mt-16 w-full bg-white text-dark-black zindex-1" >
            <h3 className="max-sm:text-lg max-lg:font-2xl tracking-normal  leading-none font-normal pb-6">
